            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <label for="category" class="col-sm-1 control-label">Section</label>
...
<script>
$(function() {
  // When the form with id="addnew" is submitted
  $('#addnew form').submit(function(e) {
    // Get the Stock entered by the user in the "Stock" input field
    var stock = parseInt($('#stock').val());

    // Check if the Stock is greater than 100
    if (stock < 100) {
      // If it's greater than 100, set the Stock to 100
      $('#stock').val(100);
    }
  });
});
